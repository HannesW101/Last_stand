...
void Texture_manager::init(bool const smooth_textures) {
    ...
    if (_is_initialized) {
        ...
        _load(Texture_id::CHARACTER__SIR_BLACKWOOD__ATTACK_2,   TEXTURE_PATH__CHARACTERS__SIR_BLACKWOOD__ATTACK_2);
        _load(Texture_id::CHARACTER__SIR_BLACKWOOD__ATTACK_3,   TEXTURE_PATH__CHARACTERS__SIR_BLACKWOOD__ATTACK_3);
        _load(Texture_id::CHARACTER__SIR_BLACKWOOD__DEAD,       TEXTURE_PATH__CHARACTERS__SIR_BLACKWOOD__DEAD);
        _load(Texture_id::CHARACTER__SIR_BLACKWOOD__DEFEND,     TEXTURE_PATH__CHARACTERS__SIR_BLACKWOOD__DEFEND);
        _load(Texture_id::CHARACTER__SIR_BLACKWOOD__HURT,       TEXTURE_PATH__CHARACTERS__SIR_BLACKWOOD__HURT);
        _load(Texture_id::CHARACTER__SIR_BLACKWOOD__IDLE,       TEXTURE_PATH__CHARACTERS__SIR_BLACKWOOD__IDLE);
        _load(Texture_id::CHARACTER__SIR_BLACKWOOD__JUMP,       TEXTURE_PATH__CHARACTERS__SIR_BLACKWOOD__JUMP);
        _load(Texture_id::CHARACTER__SIR_BLACKWOOD__PROTECT,    TEXTURE_PATH__CHARACTERS__SIR_BLACKWOOD__PROTECT);
